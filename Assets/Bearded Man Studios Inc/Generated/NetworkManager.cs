...
namespace BeardedManStudios.Forge.Networking.Unity
{
	public partial class NetworkManager : MonoBehaviour
	{
		...
		public GameObject[] CampfireSpotNetworkObject = null;
		...
		public GameObject[] KinectControlsNetworkObject = null;
		...
		private void CaptureObjects(NetworkObject obj)
		{
			...
			if (obj is CampfireSpotNetworkObject)
			{
				MainThreadManager.Run(() =>
				{
					...
					{
						if (CampfireSpotNetworkObject.Length > 0 && CampfireSpotNetworkObject[obj.CreateCode] != null)
						{
							var go = Instantiate(CampfireSpotNetworkObject[obj.CreateCode]);
							newObj = go.GetComponent<CampfireSpotBehavior>();
						}
					}
			...
			else if (obj is KinectControlsNetworkObject)
			{
				MainThreadManager.Run(() =>
				{
					NetworkBehavior newObj = null;
					if (!NetworkBehavior.skipAttachIds.TryGetValue(obj.NetworkId, out newObj))
					{
						if (KinectControlsNetworkObject.Length > 0 && KinectControlsNetworkObject[obj.CreateCode] != null)
						{
							var go = Instantiate(KinectControlsNetworkObject[obj.CreateCode]);
							newObj = go.GetComponent<KinectControlsBehavior>();
						}
					}
		...
		[Obsolete("Use InstantiateCampfireSpot instead, its shorter and easier to type out ;)")]
		public CampfireSpotBehavior InstantiateCampfireSpotNetworkObject(int index = 0, Vector3? position = null, Quaternion? rotation = null, bool sendTransform = true)
		{
			var go = Instantiate(CampfireSpotNetworkObject[index]);
			var netBehavior = go.GetComponent<CampfireSpotBehavior>();
			var obj = netBehavior.CreateNetworkObject(Networker, index);
			go.GetComponent<CampfireSpotBehavior>().networkObject = (CampfireSpotNetworkObject)obj;
		...
		[Obsolete("Use InstantiateKinectControls instead, its shorter and easier to type out ;)")]
		public KinectControlsBehavior InstantiateKinectControlsNetworkObject(int index = 0, Vector3? position = null, Quaternion? rotation = null, bool sendTransform = true)
		{
			var go = Instantiate(KinectControlsNetworkObject[index]);
			var netBehavior = go.GetComponent<KinectControlsBehavior>();
			var obj = netBehavior.CreateNetworkObject(Networker, index);
			go.GetComponent<KinectControlsBehavior>().networkObject = (KinectControlsNetworkObject)obj;
		...
		/// <summary>
		/// Instantiate an instance of CampfireSpot
		/// </summary>
		/// <returns>
		/// A local instance of CampfireSpotBehavior
		/// </returns>
		/// <param name="index">The index of the CampfireSpot prefab in the NetworkManager to Instantiate</param>
		/// <param name="position">Optional parameter which defines the position of the created GameObject</param>
		/// <param name="rotation">Optional parameter which defines the rotation of the created GameObject</param>
		/// <param name="sendTransform">Optional Parameter to send transform data to other connected clients on Instantiation</param>
		public CampfireSpotBehavior InstantiateCampfireSpot(int index = 0, Vector3? position = null, Quaternion? rotation = null, bool sendTransform = true)
		{
			var go = Instantiate(CampfireSpotNetworkObject[index]);
			var netBehavior = go.GetComponent<CampfireSpotBehavior>();
		...
		/// <summary>
		/// Instantiate an instance of KinectControls
		/// </summary>
		/// <returns>
		/// A local instance of KinectControlsBehavior
		/// </returns>
		/// <param name="index">The index of the KinectControls prefab in the NetworkManager to Instantiate</param>
		/// <param name="position">Optional parameter which defines the position of the created GameObject</param>
		/// <param name="rotation">Optional parameter which defines the rotation of the created GameObject</param>
		/// <param name="sendTransform">Optional Parameter to send transform data to other connected clients on Instantiation</param>
		public KinectControlsBehavior InstantiateKinectControls(int index = 0, Vector3? position = null, Quaternion? rotation = null, bool sendTransform = true)
		{
			var go = Instantiate(KinectControlsNetworkObject[index]);
			var netBehavior = go.GetComponent<KinectControlsBehavior>();
