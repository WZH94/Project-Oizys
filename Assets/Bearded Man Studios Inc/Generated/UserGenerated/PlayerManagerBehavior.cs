...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	[GeneratedRPCVariableNames("{\"types\":[[\"campfireIndex\"]]")]
	public abstract partial class PlayerManagerBehavior : NetworkBehavior
	{
		public const byte RPC_FORCE_CAMPFIRE_SESSION = 0 + 5;
		...
		public override void Initialize(NetworkObject obj)
		{
			...
			networkObject.RegisterRpc("ForceCampfireSession", ForceCampfireSession, typeof(int));
		...
		/// int campfireIndex
		/// </summary>
		public abstract void ForceCampfireSession(RpcArgs args);
